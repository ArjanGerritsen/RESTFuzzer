<template>
  ...
  >
    ...
    <template slot="modal-footer" slot-scope="{ cancel }">
      <b-button variant="primary" @click="updateSetting()">
...
export default {
  ...
  methods: {
    ...
    async updateSetting() {
      await this.restService.updateSetting(this.setting)
        .then(response => {
          this.messageService.info("Update setting", "Setting updated successful.");

          Store.commit('admin_setting_set', { setting: this.setting });
